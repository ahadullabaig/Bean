...
def render_pdf(report: FullReport) -> BytesIO:
    ...
    story.append(Paragraph(f"<i>Generated by Bean | Confidence: {report.confidence_score:.0%}</i>", 
                          ParagraphStyle('Footer', parent=styles['Normal'], fontSize=9, textColor=HexColor('#718096'))))
